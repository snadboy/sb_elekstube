...
void Backlights::loop()
{
  ...
  else if (config->pattern == constant)
  {
    ...
    if (dimming)
    {
      setBrightness(0xFF >> max_intensity - dimming_intensity - 1);
    }
    else
    {
      setBrightness(0xFF >> max_intensity - config->intensity - 1);
...
void Backlights::testPattern()
{
  ...
  if (dimming)
  {
    setBrightness(0xFF >> max_intensity - (uint8_t)dimming_intensity - 1);
  }
  else
  {
    setBrightness(0xFF >> max_intensity - config->intensity - 1);
